...
const Searchbar = forwardRef<HTMLInputElement, SearchT>((props, ref) => {
    return (
        <div className={`${props.className} flex flex-row items-center w-full gap-2 p-2 rounded-xl`}>
            <div className="text-white flex justify-center items-center h-[24px] w-[24px]">
            ...
            <input autoFocus ref={ref} value={props.value}
                   className="bg-transparent border-b-1 text-white border-b  outline-transparent focus:outline-transparent w-full py-1 text-4 mr-2"
                   type='text'
                   onChange={(e) => {
